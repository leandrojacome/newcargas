      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            notaFiscalColetaOrigem: expect.any(Object),
            notaFiscalColetaDestino: expect.any(Object),
            solicitacaoColetaOrigem: expect.any(Object),
            solicitacaoColetaDestino: expect.any(Object),
          }),
        );
      });
