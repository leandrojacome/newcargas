...
describe('Transportadora Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'transportadora', component: TransportadoraComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.transportadoras?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to transportadoraService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTransportadoraIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTransportadoraIdentifier).toHaveBeenCalledWith(entity);
