...
import { TransportadoraDeleteDialogComponent } from './transportadora-delete-dialog.component';
...
describe('Transportadora Management Delete Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, TransportadoraDeleteDialogComponent],
