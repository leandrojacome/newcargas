...
describe('Notificacao Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'notificacao', component: NotificacaoComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.notificacaos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to notificacaoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getNotificacaoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getNotificacaoIdentifier).toHaveBeenCalledWith(entity);
