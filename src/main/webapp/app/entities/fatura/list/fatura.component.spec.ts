...
describe('Fatura Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'fatura', component: FaturaComponent }]), HttpClientTestingModule, FaturaComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to faturaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFaturaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFaturaIdentifier).toHaveBeenCalledWith(entity);
