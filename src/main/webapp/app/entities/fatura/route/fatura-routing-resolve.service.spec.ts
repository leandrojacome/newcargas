...
import faturaResolve from './fatura-routing-resolve.service';

describe('Fatura routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: FaturaService;
  let resultFatura: IFatura | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IFatura returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        faturaResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultFatura = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultFatura).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IFatura>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
