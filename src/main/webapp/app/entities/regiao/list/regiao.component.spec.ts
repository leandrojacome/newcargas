...
describe('Regiao Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'regiao', component: RegiaoComponent }]), HttpClientTestingModule, RegiaoComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.regiaos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to regiaoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRegiaoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRegiaoIdentifier).toHaveBeenCalledWith(entity);
