...
import br.com.revenuebrasil.newcargas.web.rest.dto.EntityAuditEvent;
...
public class JaversEntityAuditResource {
    ...
    public ResponseEntity<List<EntityAuditEvent>> getChanges(
        ...
        Class entityTypeToFetch = Class.forName("br.com.revenuebrasil.newcargas.domain." + entityType);
    ...
    public ResponseEntity<EntityAuditEvent> getPrevVersion(
        ...
        Class entityTypeToFetch = Class.forName("br.com.revenuebrasil.newcargas.domain." + qualifiedName);
