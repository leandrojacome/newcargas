...
/**
 * REST controller for managing {@link br.com.revenuebrasil.newcargas.domain.Endereco}.
 */
@RestController
...
public class EnderecoResource {
    ...
    /**
     * {@code SEARCH  /enderecos/_search?query=:query} : search for the endereco corresponding
     * to the query.
     *
     ...
     */
    @GetMapping("/_search")
    public ResponseEntity<List<EnderecoDTO>> searchEnderecos(
