...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "formacobranca")
@SuppressWarnings("common-java:DuplicatedBlocks")
@JsonFilter("lazyPropertyFilter")
public class FormaCobranca extends AbstractAuditingEntity<Long> implements Serializable {
    ...
    public FormaCobranca createdBy(String createdBy) {
        this.setCreatedBy(createdBy);
        return this;
    }

    // Inherited createdDate methods
    public FormaCobranca createdDate(Instant createdDate) {
        this.setCreatedDate(createdDate);
        return this;
    }

    // Inherited lastModifiedBy methods
    public FormaCobranca lastModifiedBy(String lastModifiedBy) {
        this.setLastModifiedBy(lastModifiedBy);
        return this;
    }

    // Inherited lastModifiedDate methods
    public FormaCobranca lastModifiedDate(Instant lastModifiedDate) {
