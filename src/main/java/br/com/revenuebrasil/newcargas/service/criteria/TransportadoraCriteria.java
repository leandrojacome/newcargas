...
/**
 * Criteria class for the {@link br.com.revenuebrasil.newcargas.domain.Transportadora} entity. This class is used
 * in {@link br.com.revenuebrasil.newcargas.web.rest.TransportadoraResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /transportadoras?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TransportadoraCriteria implements Serializable, Criteria {
    ...
    public TransportadoraCriteria() {}

    public TransportadoraCriteria(TransportadoraCriteria other) {
    ...
    @Override
    public TransportadoraCriteria copy() {
        return new TransportadoraCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TransportadoraCriteria that = (TransportadoraCriteria) o;
        return (
