...
/**
 * Criteria class for the {@link br.com.revenuebrasil.newcargas.domain.TipoFrete} entity. This class is used
 * in {@link br.com.revenuebrasil.newcargas.web.rest.TipoFreteResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /tipo-fretes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TipoFreteCriteria implements Serializable, Criteria {
    ...
    public TipoFreteCriteria() {}

    public TipoFreteCriteria(TipoFreteCriteria other) {
    ...
    @Override
    public TipoFreteCriteria copy() {
        return new TipoFreteCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TipoFreteCriteria that = (TipoFreteCriteria) o;
        return (
